...
function playHomeSong(file){
	document.getElementById('songDiscripHome').style.display = 'none';
	document.getElementById('homeSongDiv').style.display = 'block';
...
$(function(){
	...
	var appDiscript = $('#songDiscripHome');
	$('#homeSongBtnStop').click(function(){
	homeSongDiv.css('display', 'none');
	appDiscript.css('display', 'block');
	music.pause();
	music = new Audio(file);
	music.pause();
	document.getElementById('homeSongBtnCheck').innerHTML = 0;
...
document.getElementById("pg7HeaderTitle").innerHTML = 'Assurance and Certainty';
...
document.getElementById("pg7HeaderTitle").innerHTML = 'Bible (Word of God)';
var ciAssu = $('#classifiedIndexp7');
ciAssu.empty();   //To prevent duplication
	for(var i of cIndex1){
		ciAssu.append('<li><a class="ui-btn classifiedIndexCon" id="'+
...
document.getElementById("pg7HeaderTitle").innerHTML = 'Christmas';
var ciAssu = $('#classifiedIndexp7');
ciAssu.empty();   //To prevent duplication
	for(var i of cIndex1){
		ciAssu.append('<li><a class="ui-btn classifiedIndexCon" id="'+
...
document.getElementById("pg7HeaderTitle").innerHTML = 'Conflict';
var ciAssu = $('#classifiedIndexp7');
ciAssu.empty();   //To prevent duplication
	for(var i of cIndex1){
		ciAssu.append('<li><a class="ui-btn classifiedIndexCon" id="'+
...
document.getElementById("pg7HeaderTitle").innerHTML = 'Cross';
var ciAssu = $('#classifiedIndexp7');
ciAssu.empty();   //To prevent duplication
	for(var i of cIndex1){
		ciAssu.append('<li><a class="ui-btn classifiedIndexCon" id="'+
...
document.getElementById("pg7HeaderTitle").innerHTML = 'Forgiveness';
var ciAssu = $('#classifiedIndexp7');
ciAssu.empty();   //To prevent duplication
	for(var i of cIndex1){
		ciAssu.append('<li><a class="ui-btn classifiedIndexCon" id="'+
...
document.getElementById("pg7HeaderTitle").innerHTML = 'Faith';
var ciAssu = $('#classifiedIndexp7');
ciAssu.empty();   //To prevent duplication
	for(var i of cIndex1){
		ciAssu.append('<li><a class="ui-btn classifiedIndexCon" id="'+
...
document.getElementById("pg7HeaderTitle").innerHTML = 'Gospel Call';
var ciAssu = $('#classifiedIndexp7');
ciAssu.empty();   //To prevent duplication
	for(var i of cIndex1){
		ciAssu.append('<li><a class="ui-btn classifiedIndexCon" id="'+
...
document.getElementById("pg7HeaderTitle").innerHTML = 'Guidance';
var ciAssu = $('#classifiedIndexp7');
ciAssu.empty();   //To prevent duplication
	for(var i of cIndex1){
		ciAssu.append('<li><a class="ui-btn classifiedIndexCon" id="'+
...
document.getElementById("pg7HeaderTitle").innerHTML = 'Heaven';
var ciAssu = $('#classifiedIndexp7');
ciAssu.empty();   //To prevent duplication
	for(var i of cIndex1){
		ciAssu.append('<li><a class="ui-btn classifiedIndexCon" id="'+
...
document.getElementById("pg7HeaderTitle").innerHTML = 'Joy';
var ciAssu = $('#classifiedIndexp7');
ciAssu.empty();   //To prevent duplication
	for(var i of cIndex1){
		ciAssu.append('<li><a class="ui-btn classifiedIndexCon" id="'+
...
document.getElementById("pg7HeaderTitle").innerHTML = 'Life';
var ciAssu = $('#classifiedIndexp7');
ciAssu.empty();   //To prevent duplication
	for(var i of cIndex1){
		ciAssu.append('<li><a class="ui-btn classifiedIndexCon" id="'+
...
document.getElementById("pg7HeaderTitle").innerHTML = 'Lord Jesus';
var ciAssu = $('#classifiedIndexp7');
ciAssu.empty();   //To prevent duplication
	for(var i of cIndex1){
		ciAssu.append('<li><a class="ui-btn classifiedIndexCon" id="'+
...
document.getElementById("pg7HeaderTitle").innerHTML = 'Love of God';
var ciAssu = $('#classifiedIndexp7');
ciAssu.empty();   //To prevent duplication
	for(var i of cIndex1){
		ciAssu.append('<li><a class="ui-btn classifiedIndexCon" id="'+
...
document.getElementById("pg7HeaderTitle").innerHTML = 'Missionary';
var ciAssu = $('#classifiedIndexp7');
ciAssu.empty();   //To prevent duplication
	for(var i of cIndex1){
		ciAssu.append('<li><a class="ui-btn classifiedIndexCon" id="'+
...
document.getElementById("pg7HeaderTitle").innerHTML = 'Praise';
var ciAssu = $('#classifiedIndexp7');
ciAssu.empty();   //To prevent duplication
	for(var i of cIndex1){
		ciAssu.append('<li><a class="ui-btn classifiedIndexCon" id="'+
...
document.getElementById("pg7HeaderTitle").innerHTML = 'Prayer';
var ciAssu = $('#classifiedIndexp7');
ciAssu.empty();   //To prevent duplication
	for(var i of cIndex1){
		ciAssu.append('<li><a class="ui-btn classifiedIndexCon" id="'+
...
document.getElementById("pg7HeaderTitle").innerHTML = 'Salvation';
var ciAssu = $('#classifiedIndexp7');
ciAssu.empty();   //To prevent duplication
	for(var i of cIndex1){
		ciAssu.append('<li><a class="ui-btn classifiedIndexCon" id="'+
...
document.getElementById("pg7HeaderTitle").innerHTML = 'Sanctification';
var ciAssu = $('#classifiedIndexp7');
ciAssu.empty();   //To prevent duplication
	for(var i of cIndex1){
		ciAssu.append('<li><a class="ui-btn classifiedIndexCon" id="'+
...
document.getElementById("pg7HeaderTitle").innerHTML = 'Second Coming';
var ciAssu = $('#classifiedIndexp7');
ciAssu.empty();   //To prevent duplication
	for(var i of cIndex1){
		ciAssu.append('<li><a class="ui-btn classifiedIndexCon" id="'+
...
document.getElementById("pg7HeaderTitle").innerHTML = 'Service';
var ciAssu = $('#classifiedIndexp7');
ciAssu.empty();   //To prevent duplication
	for(var i of cIndex1){
		ciAssu.append('<li><a class="ui-btn classifiedIndexCon" id="'+
...
document.getElementById("pg7HeaderTitle").innerHTML = 'Sin';
var ciAssu = $('#classifiedIndexp7');
ciAssu.empty();   //To prevent duplication
	for(var i of cIndex1){
		ciAssu.append('<li><a class="ui-btn classifiedIndexCon" id="'+
...
document.getElementById("pg7HeaderTitle").innerHTML = 'Strength';
var ciAssu = $('#classifiedIndexp7');
ciAssu.empty();   //To prevent duplication
	for(var i of cIndex1){
		ciAssu.append('<li><a class="ui-btn classifiedIndexCon" id="'+
...
document.getElementById("pg7HeaderTitle").innerHTML = 'Surrender';
var ciAssu = $('#classifiedIndexp7');
ciAssu.empty();   //To prevent duplication
	for(var i of cIndex1){
		ciAssu.append('<li><a class="ui-btn classifiedIndexCon" id="'+
...
document.getElementById("pg7HeaderTitle").innerHTML = 'Thanksgiving';
var ciAssu = $('#classifiedIndexp7');
ciAssu.empty();   //To prevent duplication
	for(var i of cIndex1){
		ciAssu.append('<li><a class="ui-btn classifiedIndexCon" id="'+
...
document.getElementById("pg7HeaderTitle").innerHTML = 'Victory';
var ciAssu = $('#classifiedIndexp7');
ciAssu.empty();   //To prevent duplication
	for(var i of cIndex1){
		ciAssu.append('<li><a class="ui-btn classifiedIndexCon" id="'+
...
document.getElementById("pg7HeaderTitle").innerHTML = 'Witness';
var ciAssu = $('#classifiedIndexp7');
ciAssu.empty();   //To prevent duplication
	for(var i of cIndex1){
		ciAssu.append('<li><a class="ui-btn classifiedIndexCon" id="'+
...
document.getElementById("pg7HeaderTitle").innerHTML = 'Children';
var ciAssu = $('#classifiedIndexp7');
ciAssu.empty();   //To prevent duplication
	for(var i of cIndex1){
		ciAssu.append('<li><a class="ui-btn classifiedIndexCon" id="'+
